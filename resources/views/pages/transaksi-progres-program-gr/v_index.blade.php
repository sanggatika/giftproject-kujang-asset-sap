    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-lg-3 col-md-3">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input type="text" name="form_filter_program_gr_nomor" id="form_filter_program_gr_nomor" class="form-control mb-2" placeholder="Nomor Good Receipt (GR)"/>
                <!--end::Input-->
            </div>
            <div class="col-12 col-lg-3 col-md-3">
                <!--begin::Label-->
                <label class="form-label fw-bold">Tanggal Good Receipt (GR) : </label>
                <!--end::Label-->
                ...
                <div class="position-relative d-flex align-items-center">
                    ...
                    <!--end::Icon-->
                    <!--begin::Datepicker-->
                    <input class="form-control ps-12" placeholder="Select a date" placeholder="Range Tanggal Good Receipt (GR)" id="form_filter_program_gr_tanggal" name="form_filter_program_gr_tanggal"/>
                    <!--end::Datepicker-->
                </div>
                <!--end::Input-->
            </div>
            ...
            <div class="col-lg-3 mb-2">
                <div class="mb-5">
                    <div class="d-flex flex-stack">
                        <div class="fw-bolder fs-4">Total Program Realisasi
                            <span class="fs-6 text-gray-400 ms-2"></span>
                        </div>
                        <!--begin::Menu-->
                        <div>
                    ...
                    <div class="card-body p-5">                            
                        <div class="d-flex justify-content-between mt-1">
                            <div class="sales-info d-flex align-items-center">
                                ...
                                <div class="sales-info-content">
                                    <h6 class="mb-0">Program Realisasi</h6>
                                </div>
                            </div>
                            <h5 class="mb-0 fw-bold" id="data_line2_program_total_realisasi">0</h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 mb-2">
                <div class="mb-5">
                    <div class="d-flex flex-stack">
                        <div class="fw-bolder fs-4">Sisa Program Realisasi
                            <span class="fs-6 text-gray-400 ms-2"></span>
                        </div>
                        <!--begin::Menu-->
                        <div>
                ...
                <div class="card bg-light-warning shadow-sm card-xl-stretch">
                    <div class="card-body p-5">                            
                        <div class="d-flex justify-content-between mt-1">
                            <div class="sales-info d-flex align-items-center">
                                <i class="bi bi-distribute-vertical fs-1 me-2 text-primary"></i>
                                <div class="sales-info-content">
                                    <h6 class="mb-0">Sisa Realisasi</h6>
                                </div>
                            </div>
                            <h5 class="mb-0 fw-bold" id="data_line2_program_total_realisasi_sisa">0</h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 mb-2">
                <div class="mb-5">
                    <div class="d-flex flex-stack">
                        <div class="fw-bolder fs-4">Data Progres (GR)
                            <span class="fs-6 text-gray-400 ms-2"></span>
                        </div>
                        <!--begin::Menu-->
                        <div>
