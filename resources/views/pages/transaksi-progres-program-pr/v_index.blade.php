...
@section('title', '- Transaksi Progres Program - Purchase Requisition (PR)')
...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Transaksi Progres Program - Purchase Requisition (PR)</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Progres Program - Purchase Requisition (PR)</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-lg-3 col-md-3">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input type="text" name="form_filter_program_pr_nomor" id="form_filter_program_pr_nomor" class="form-control mb-2" placeholder="Nomor Purchase Requisition (PR)"/>
                <!--end::Input-->
            </div>
            <div class="col-12 col-lg-3 col-md-3">
                <!--begin::Label-->
                <label class="form-label fw-bold">Tanggal Purchase Requisition (PR) : </label>
                <!--end::Label-->
                ...
                <div class="position-relative d-flex align-items-center">
                    ...
                    <!--end::Icon-->
                    <!--begin::Datepicker-->
                    <input class="form-control ps-12" placeholder="Select a date" placeholder="Range Tanggal Purchase Requisition (PR)" id="form_filter_program_pr_tanggal" name="form_filter_program_pr_tanggal"/>
                    <!--end::Datepicker-->
                </div>
                <!--end::Input-->
            </div>
            ...
            <div class="col-lg-3 mb-2">
                <div class="mb-5">
                    <div class="d-flex flex-stack">
                        <div class="fw-bolder fs-4">Total Purchase Requisition (PR)
                        ...
                        <div class="d-flex justify-content-between mt-1">
                            <div class="sales-info d-flex align-items-center">
                                ...
                                <div class="sales-info-content">
                                    <h6 class="mb-0">Purchase Req</h6>
                                </div>
                            </div>
                            <h5 class="mb-0 fw-bold" id="data_line2_program_total_pr">0</h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 mb-2">
                <div class="mb-5">
                    <div class="d-flex flex-stack">
                        <div class="fw-bolder fs-4">Purchase Requisition (PR) - Progres
                            <span class="fs-6 text-gray-400 ms-2"></span>
                        </div>
                        <!--begin::Menu-->
                        <div>
                ...
                <div class="card bg-light-warning shadow-sm card-xl-stretch">
                    <div class="card-body p-5">                            
                        <div class="d-flex justify-content-between mt-1">
                            ...
                            <h5 class="mb-0 fw-bold" id="data_line2_program_total_pr_progres">0</h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 mb-2">
                <div class="mb-5">
                    <div class="d-flex flex-stack">
                        <div class="fw-bolder fs-4">Purchase Order (PO)
                            <span class="fs-6 text-gray-400 ms-2"></span>
                        </div>
                        <!--begin::Menu-->
                        <div>
                ...
                <div class="card bg-light-warning shadow-sm card-xl-stretch">
                    <div class="card-body p-5">                            
                        <div class="d-flex justify-content-between mt-1">
                            ...
                            <h5 class="mb-0 fw-bold" id="data_line2_program_total_pr_selesai">0</h5>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="modal-tambah-po" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" data-bs-focus="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" class="form-control" name="form_masterdata_program_pr_nomor_po" id="form_masterdata_program_pr_nomor_po" placeholder="Nomor Purchase Requisition (PR)" aria-label="Nomor Purchase Requisition (PR)" value="" aria-describedby="basic-addon1"/>
                                        </div>                                            
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-select mb-2" name="form_masterdata_program_pr_jenis_po" id="form_masterdata_program_pr_jenis_po"  data-control="select2" data-placeholder="Select an option" data-dropdown-parent="#modal-tambah-po" disabled>
                                    <option value="-">-- Program Jenis CCK -- </option> 
                                    @foreach ($model['ms_program_jenis_cck'] as $program_jenis_cck)
                                        <option value="{{$program_jenis_cck->uuid}}">{{$program_jenis_cck->name}}</option>
                                    @endforeach                             
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Datepicker-->
                                    <input class="form-control ps-12" placeholder="Select a date" value="{{date('Y-m-d')}}" placeholder="{{date('Y-m-d')}}" id="form_masterdata_program_pr_tanggal_po" name="form_masterdata_program_pr_tanggal_po" disabled/>
                                    <!--end::Datepicker-->
                                </div>
                                <!--end::Input-->
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="form_masterdata_program_pr_nama_po" id="form_masterdata_program_pr_nama_po" placeholder="Nama Program" aria-label="Nama Program" value="" aria-describedby="basic-addon1" disabled/>
                                    <input type="hidden" class="form-control" name="form_masterdata_program_pr_uuid_po" id="form_masterdata_program_pr_uuid_po" value="" aria-describedby="basic-addon1"/>
                                </div>
                                <!--end::Input group-->        
                            </div>                               
                            ...
                            <div class="form-group mb-3">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-select mb-2" name="form_masterdata_program_pr_lokasi_po" id="form_masterdata_program_pr_lokasi_po"  data-control="select2" data-placeholder="Select an option" data-dropdown-parent="#modal-tambah-po" disabled>
                                    <option value="-">-- Program Lokasi CC -- </option> 
                                    @foreach ($model['ms_program_lokasi_cc'] as $program_lokasi_cc)
                                        <option value="{{$program_lokasi_cc->uuid}}">{{$program_lokasi_cc->name}}</option>
                                    @endforeach                             
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="number" class="form-control" name="form_masterdata_program_pr_nominal_po" id="form_masterdata_program_pr_nominal_po" placeholder="Anggaran Purchase Requisition (PR)" aria-label="Anggaran Purchase Requisition (PR)" value="" aria-describedby="basic-addon1" disabled/>
                                </div>
                                <!--end::Input group-->
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 dataContenFormPR">
                            <div class="form-group mb-3">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-select mb-2" name="form_masterdata_program_po_otoritas" id="form_masterdata_program_po_otoritas"  data-control="select2" data-placeholder="Select an option" data-dropdown-parent="#modal-tambah-po" >
                        ...
                        <div class="col-md-12">
                            <div class="d-flex float-md-end">
                                <button type="button" class="btn btn-primary mt-2" id="btnTambahMasterdata" onclick="act_submitTambahDataPO()">
