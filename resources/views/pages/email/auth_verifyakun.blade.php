			...
			<tr>
				<td align="left" valign="center">
					<div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
						...
						<div style="padding-bottom: 30px">Sistem kami menerima permohonan untuk verifikasi akun anda.<br>Jika anda yang melakukan ini, silahkan klik tombol dibawah untuk verifikasi akun. Jika bukan anda yang melakukan ini, abaikan email ini dan tetap waspada terhadap keamanan akun anda dengan mengubah password kamu secara berkala.</div>
						
						<div style="padding-bottom: 5px; text-align:center;">
							<h1 style="letter-spacing: 10px;">{{ $pin }}</h1>
						</div>
