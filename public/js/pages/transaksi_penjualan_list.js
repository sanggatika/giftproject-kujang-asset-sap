...
function serverSideDatatables()
{
    ...
    $('#tabel_master_data').DataTable({
        ...
        pageLength: 10,
        ajax: {
            url: BaseURL + "/transaksi/penjualan/get_datatable",
            type: "POST",
            data: {
...
function act_btnDonloadExcell()
{
    ...
    $.ajax({
        ...
        url: BaseURL + "/dev/export/excell/transaksi/penjualan",
        data: {
            form_filter_customer,
            form_filter_barang,
        ...
        success: function (result, status, xhr) {
            ...
            var filename = (matches != null && matches[1] ? matches[1] : 'data-transaksi-penjualan-'+data_time+'.xlsx');
