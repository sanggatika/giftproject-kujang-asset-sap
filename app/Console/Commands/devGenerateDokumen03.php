...
class devGenerateDokumen03 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dev:dev-generate-dokumen03';
     ...
     * @var string
     */
    protected $description = '[Dev] Proses Generate Dokumen Test S3 Service 03';
