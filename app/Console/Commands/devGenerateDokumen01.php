...
class devGenerateDokumen01 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dev:dev-generate-dokumen01';
     ...
     * @var string
     */
    protected $description = '[Dev] Proses Generate Dokumen Test S3 Service 01';
